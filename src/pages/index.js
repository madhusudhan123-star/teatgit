...
import { Theme, Link, Button, Text, Box, Icon, Image, Input, Hr } from "@quarkly/widgets";
		...
		>
			...
			<Stack>
				...
				<StackItem display="flex" quarkly-title="Logo" md-width="75%" width="25%">
					<Override slot="StackItemContent" align-items="center" xl-font="16px " />
					{"        "}
				...
				<StackItem display="flex" quarkly-title="Side" width="25%" md-display="none">
					...
					<Button
						...
						hover-align-self="flex-end"
						hover-color="--light"
						hover-box-shadow="inset 0 0 0 0 --color-primary"
						hover-background="#e88737"
						hover-border-color="#f68336"
